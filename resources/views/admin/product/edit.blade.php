                                ...
                                <div class="card-body">
                                    <form method="post" action="admin/product/{{$product->id}}" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <select required name="id_coffee_brand" id="id_coffee_brand" class="form-control">
                                                    ...
                                                    @foreach($brands as $brand)
                                                        <option {{$product->id_coffee_brand == $brand->id ? 'selected' : ''}}
                                                                value={{$brand -> id}}>
                                                            {{$brand -> name}}
                                                        </option>
                                                    @endforeach
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <select required name="id_coffee_category" id="id_coffee_category" class="form-control">
                                                    ...
                                                    @foreach($productCategories as $productCategory)
                                                        <option {{$product->id_coffee_category == $productCategory->id ? 'selected' : ''}}
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input required name="price" id="price"
                                                    placeholder="Giá cả" type="text" class="form-control" value="{{$product-> price}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input required name="discount" id="discount"
                                                    placeholder="Giá ban đầu" type="text" class="form-control" value="{{$product-> discount}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input required name="weight" id="weight"
                                                    placeholder="Sản phầm tồn hàng" type="text" class="form-control" value="{{$product-> weight}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <textarea class="form-control" name="description" id="description" placeholder="Nhập thông tin sản phẩm">{{$product-> description}}</textarea>
                                            </div>
                                        </div>
